...
MODEL_PATH    = os.path.join(PROJECT_DIR , "deployment", "scoring.pkl")
...
############################################################################
modele = pickle.load( open( SCORING_V1_MODEL_PATH, "rb" ) )
...
Purpose  = st.sidebar.selectbox("Purpose", ['rent', 'own', 'for free'])
